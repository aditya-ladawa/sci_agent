...
async def _run(args: argparse.Namespace) -> None:
    ...
    if args.skip_agent:
        ...
        from agent_arcs.multi_agent_arc.smoke_test import _report_placeholder_issues, _stream_run
    ...
    if not args.skip_eval:
        ...
        race_metrics = _run_race(q_no=args.q_no, question=question, article_text=article_text, paths=paths, force=args.force_eval or not args.skip_agent)
